...
export const HOME_SERVICES: StickyScrollSectionData = {
...
export const HOME_CTA_SERVICES: CTABannerData = {
...
export const HOME_INDUSTRIES: IndustriesGridData = {
...
export const HOME_PROCESS: StickyScrollSectionData = {
...
export const HOME_CASE_STUDIES: CaseStudyCardData[] = [
  {
...
export const HOME_BEFORE_AFTER: BeforeAfterData = {
  headline: "The difference is visible",
  highlightedWord: "visible",
  description: "Real before-and-after transformations from our client projects.",
  pairs: [
    {
...
export const HOME_CTA_AUDIT: CTABannerData = {
...
export const HOME_TESTIMONIALS: TestimonialData[] = [
  {
    quote:
...
export const HOME_CTA_CONSULTATION: CTABannerData = {
...
export const HOME_LIVE_FEED: LabContentCard[] = [
  {
