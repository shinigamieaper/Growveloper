...
export function AutomationHero({ data, className, ...props }: AutomationHeroProps) {
  ...
  return (
    <section className={cn("relative", className)} {...props}>
      ...
      {/* Price card + CTAs — outside LampContainer so they sit below the glow */}
      <div className="relative z-60 mx-auto -mt-32 flex max-w-xl flex-col items-center gap-8 px-6 pb-24">
        <ScrollFadeUp>
