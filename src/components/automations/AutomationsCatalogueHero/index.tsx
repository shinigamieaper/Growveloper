  ...
  return (
    <section className="relative">
      <LampContainer className="[@media(orientation:landscape)_and_(max-height:600px)]:overflow-visible">
        ...
        >
          <h1 className="heading-font text-3xl font-bold tracking-tight text-text-primary sm:text-4xl md:text-5xl lg:text-6xl [@media(orientation:landscape)_and_(max-height:600px)]:text-3xl">
            {parts ? (
              <>
                {parts[0]}
