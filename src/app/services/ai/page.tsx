...
const FEATURED_AUTOMATIONS_DATA: FeaturedAutomationsSection = {
...
const CTA_BANNER_MID: CTABannerData = {
...
export default function AIPage() {
  return (
    <>
      ...
      <SubServicesBento data={SUB_SERVICES_DATA} id="ai-services" />

      {/* Section 05 — Featured Automations (glass) */}
      <GlassSection>
        <FeaturedAutomations data={FEATURED_AUTOMATIONS_DATA} />
      </GlassSection>
